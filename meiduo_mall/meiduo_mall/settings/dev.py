...
SECRET_KEY = '#fcco39+ixh2wqoz@2+)!c0$%eaae23(z(hbx5^6b6^&#8xtk-'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True
# 设置完本地域名 hosts 之后添加 ALLOWED_HOSTS = ['www.meiduo.site']
# 但是 一旦设置 外网的 美多不能方位
...
# 全局配置 项目的 用户模型 设置自己的User对象 替换系统自带的User
AUTH_USER_MODEL = 'users.User'

# 指定自定义的用户认证后端
# UTHENTICATION_BACKENDS = ['django.contrib.auth.backends.ModelBackend']   #global_setting
...
# FastDFS相关参数
# FDFS_BASE_URL = 'http://192.168.43.112:8888/'
...
HAYSTACK_CONNECTIONS = {
    'default': {
        ...
        'URL': 'http://192.168.43.112:9200/', # Elasticsearch服务器ip地址，端口号固定为9200
